...
with row1[2]:
    loan_amount = st.number_input("Loan Amount", min_value=0, max_value=100000)

# Calculate Loan to income Ratio and display it
loan_to_income_ratio = loan_amount / income if income > 0 else 0
with row2[0]:
    st.text("Loan to Income:")
...
if st.button("Calculate"):
    ...
    # print((age, income, loan_amount, loan_tenure_months, avg_dpd_per_delinquency, delinquency_ratio, credit_utilization_ratio, num_open_accounts, residence_type, loan_purpose, loan_type))
